#define FILTER_SIZE 13         // Number of data points in the moving average 
...
float  current;                // For Lab 7 we are averaging current values 
float ampGain = 11.0;          // Gain of the signal conditioning amplifier 
...
iNewest++;   
if (iNewest > FILTER_SIZE) 
  iNewest = 0;   
iOldest++;   
if (iOldest > FILTER_SIZE) 
  iOldest = 0; 
} 
